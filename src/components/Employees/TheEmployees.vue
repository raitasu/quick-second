...
import RecuirsiveTable from "./Table/RecuirsiveTable.vue";
...
<template>
        ...
        <div class="d-flex flex-column gap-2">
          <div class="d-flex  align-items-center">
            ...
            <div class="d-flex flex-column w-100">
              <DaDataNext v-model="employee.name" :state="isValid.name" type="fio" placeholder="Enter your full name"
                          required/>
          ...
          <div class="d-flex justify-content-around align-items-center">
            ...
            <div class="d-flex flex-column w-100">
              <b-form-input type="number" v-model="employee.age" min="18" max="100" placeholder="Enter your age"
                            :state="isValid.age"></b-form-input>
          ...
          <div class="d-flex justify-content-start align-items-center">
            ...
            <div id="map" style="width: 660px; height: 300px">
              <yandex-map style="width: 100%; height: 300px" v-if="true" :coordinates="employee.location"
  ...
  <RecuirsiveTable :employees="employees"/>
</template>
<style>
.item {
  width: 100px;
